...
class CoveyGameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      'atlas',
      `/assets/atlas/${this.spriteSheetInfo.spritePNG}`,
...
export default function WorldMap(): JSX.Element {
  ...
  function renderTownMaps() {
    ...
    return (
      <div>
        <h1>
          The current map is {currentTownMap.mapName}. Only the town host have permission to change
          the map.
        </h1>
      </div>
    );
